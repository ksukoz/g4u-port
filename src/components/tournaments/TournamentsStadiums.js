...
const MyMapComponent = compose(
	withProps({
		...
		mapElement: <div style={{ height: `100%`, borderBottomLeftRadius: 20, borderBottomRightRadius: 20 }} />
	}),
	withScriptjs,
	withGoogleMap,
	lifecycle({
	...
	<GoogleMap defaultZoom={17} defaultCenter={props.defaultCenter} onClick={props.onClick}>
		{props.isMarkerShown && <Marker position={{ lat: props.lat, lng: props.lng }} onClick={props.onToggleOpen} />}
	</GoogleMap>
));
...
export default connect(mapStateToProps, { getTourStadiums })(TournamentsStadiums);
